...
export default function MartialArtsComponent(apiData) {
  ...
  const dramaDataFilter = dramaData.filter((item) => item.genre_id === 13)
  ...
  const RenderData = () => {
    return (
      <div className="pt-5 pb-3 px-5">
        <h2 className="text-white">Martial Arts</h2>
        <Swiper
          slidesPerView={6}
          spaceBetween={10}
          slidesPerGroup={3}
