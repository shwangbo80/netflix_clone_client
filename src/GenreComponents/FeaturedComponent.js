...
export default function FeaturedComponent(apiData) {
            ...
            return (
                <Modal
                    ...
                    <Modal.Body>
                        ...
                        <p>
                            Synopsis: Mobile Suit Gundam, often shortened to
                            Gundam is a Japanese space opera anime series
                            created by renowned animator Yoshiyuki Tomino and
                            produced by Sunrise[1]. Since the airing of the
                            original animated TV series Mobile Suit Gundam in
                            1979, the metaseries has grown a considerable
                            following worldwide.
                        </p>
    ...
    return (
        <div className="featuredContainer">
            ...
            <h1 className="text-white middleLeft display-2">
                MOBILE SUIT GUNDAM
            </h1>
            <Button
