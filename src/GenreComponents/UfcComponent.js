...
export default function UfcComponent(apiData) {
    ...
    const dramaDataFilter = dramaData.filter((item) => item.genre_id === "UFC");
    ...
    const RenderData = () => {
        return (
            <div className="py-2 px-5">
                <h2 className="text-white">UFC</h2>
                <Swiper
                    slidesPerView={"auto"}
                    breakpoints={{
                        300: {
